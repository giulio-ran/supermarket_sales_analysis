...
- **Profit ratio by State and by sub-category**: the Profit Ratio formula is given by $$\text{Profit Ratio} = \frac{\text{Total Profit}}{\text{Total Sales}} \times 100$$  This metric is crucial for understanding the profitability of current sales across different regions and product lines.
