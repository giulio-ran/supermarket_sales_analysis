...
I completed the RFM with the normalization of each value (to a score between 1 and 5, where number near 5 are considered optimal) and the combination, generating a syntetic score for each customer (between 1 and 15, where higher scores indicate a high quality customer).
